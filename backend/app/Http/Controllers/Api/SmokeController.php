...
class SmokeController extends Controller
{
    ...
    public function increment(Request $request)
    {
        ...
        // Aggiorna updated_at dell'utente
        $user->updated_at = now();
        $user->save(); // Questo assicura che l'utente sia considerato attivo
    ...
    // Rimosso o commentato il metodo processDaily
    /*
    public function processDaily()
    {
        // Questo metodo non dovrebbe essere qui, usa il comando Artisan invece
    }
    */
}
